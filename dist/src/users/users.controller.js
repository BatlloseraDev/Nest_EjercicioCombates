...
let UsersController = class UsersController {
    ...
    async assignCharacterToMe(req, characterId) {
        const userId = req.user.id;
        return this.usersService.assignCharacter(userId, +characterId);
    }
    async findMyCharacters(req) {
        const userId = req.user.id;
...
__decorate([
    (0, common_1.UseGuards)(jwt_guard_1.JwtGuard),
    (0, common_1.Post)('me/characters/:characterId'),
    __param(0, (0, common_2.Request)()),
    __param(1, (0, common_1.Param)('characterId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "assignCharacterToMe", null);
__decorate([
    (0, common_1.UseGuards)(jwt_guard_1.JwtGuard),
    (0, common_1.Get)('me/characters'),
    __param(0, (0, common_2.Request)()),
    __metadata("design:type", Function),
